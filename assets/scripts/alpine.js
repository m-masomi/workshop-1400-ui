...
!(function (e, t) {
  ...
  function f(e, t, n, i = {}) {
    return d(() => ("function" == typeof t ? t.call(n) : new Function(["$data", ...Object.keys(i)], `var __alpine_result; with($data) { __alpine_result = ${t} }; return __alpine_result`)(n, ...Object.values(i))), { el: e, expression: t });
  }
  ...
  function w(e, t, n, i, r = !1) {
    ...
    if (o && o.modifiers.includes("transition")) {
      ...
      (i = r ? i.filter((e, t) => t < i.indexOf("out")) : i),
        (function (e, t, n, i) {
          const r = { duration: O(t, "duration", 150), origin: O(t, "origin", "center"), first: { opacity: 0, scale: O(t, "scale", 95) }, second: { opacity: 1, scale: 100 } };
          k(e, t, n, () => {}, i, r, g);
        })(e, i, t, n);
    } else
  ...
  function E(e, t, n, i, r = !1) {
    ...
    if (o && o.modifiers.includes("transition")) {
      ...
      (i = r ? i.filter((e, t) => t > i.indexOf("out")) : i),
        (function (e, t, n, i, r) {
          const s = { duration: n ? O(t, "duration", 150) : O(t, "duration", 150) / 2, origin: O(t, "origin", "center"), first: { opacity: 1, scale: 100 }, second: { opacity: 0, scale: O(t, "scale", 95) } };
          k(e, t, () => {}, i, r, s, x);
        })(e, i, r, t, n);
    } else
  ...
  function T(e, t, n, r, o, l, c) {
    ...
    if ("value" === n) {
      ...
      if ((void 0 === u && String(r).match(/\./) && (u = ""), "radio" === t.type)) void 0 === t.attributes.value && "bind" === l ? (t.value = u) : "bind" !== l && (t.checked = s(t.value, u));
            ...
            if ((u !== window && u !== document) || document.body.contains(t)) {
              if (
                !(
                  ...
                  (i.includes("prevent") && a.preventDefault(), i.includes("stop") && a.stopPropagation(), i.includes("self") && a.target !== t)
                )
              ) {
                z(e, r, a, s).then((e) => {
  ...
  const { isArray: M } = Array,
    { getPrototypeOf: B, create: q, defineProperty: U, defineProperties: W, isExtensible: K, getOwnPropertyDescriptor: G, getOwnPropertyNames: H, getOwnPropertySymbols: V, preventExtensions: Z, hasOwnProperty: J } = Object,
        ...
        switch (i) {
          ...
          case "model":
            !(function (e, t, i, r, s) {
              ...
              N(e, t, o, i, `${r} = rightSideOfExpression($event, ${r})`, () => n(n({}, s()), {}, { rightSideOfExpression: F(t, i, r) }));
            })(this, e, s, o, t);
        }
      });
    }
